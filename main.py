...
def predict():
  ...
  data_input = np.array([[float(vibration1), float(inclination1), (float(humidity1)/100), float(precipitation1)],[float(vibration2), float(inclination2), (float(humidity2)/100), float(precipitation2)],[float(vibration3), float(inclination3), (float(humidity3)/100), float(precipitation3)]])
  ...
  if   value1 > 0.75 and value1 <= 1 :
      ...
      if not awas1 :
          ...
          status_code, response = sendNotif("titik1",nama1 , status1, url_gambar, buttons)
  ...
  if   value2 > 0.75 and value2 <= 1 :
      ...
      if not awas2 :
          ...
          status_code, response = sendNotif("titik2",nama2, status2, url_gambar, buttons)
  ...
  if   value3 > 0.75 and value3 <= 1 :
      ...
      if not awas3 :
          ...
          status_code, response = sendNotif("titik3",nama3, status3, url_gambar, buttons)
  ...
  response = requests.put(f"https://sidasibelo-default-rtdb.firebaseio.com/Data.json", json=data)
